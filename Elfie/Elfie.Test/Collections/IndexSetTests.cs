...
using System;
using System.Linq;
using Microsoft.CodeAnalysis.Elfie.Collections;
using Microsoft.CodeAnalysis.Elfie.Query;

namespace Microsoft.CodeAnalysis.Elfie.Test.Collections
{
    [TestClass]
    public class IndexSetTests
    {
        // Page fully through a set [Performance Scenario]
        public static int PageAll(IndexSet set, Span<int> page)
        {
            int count = 0;
