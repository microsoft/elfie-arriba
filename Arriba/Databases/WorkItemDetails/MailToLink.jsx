...
export default React.createClass({
    render: function () {
        ...
        var mailTo = "mailto:" + encodeURIComponent(this.props.value) + "?subject=" + encodeURIComponent(this.props.table + "." + this.props.itemId) + "&body=" + encodeURIComponent(linkToItem);
