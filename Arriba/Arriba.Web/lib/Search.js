...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ArribaComponents__ = __webpack_require__(11);
    ...
    render: function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["a" /* DetailReportLink */], { url: "https://insights/Report?id=07e846a5-a100-498b-8fe0-68a907b695cc&isPublished=true#assetName={ID}&_tab=0", id: this.props.data["Name"], title: "Patch Compliance Summary" })
            ),
            React.createElement(
                "table",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev5_OutCycleCount"], columnName: "Sev5_OutCycleCount" })
                        ),
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev4_OutCycleCount"], columnName: "Sev4_OutCycleCount" })
                        ),
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev3_OutCycleCount"], columnName: "Sev3_OutCycleCount" })
                        )
                    ),
                    React.createElement(
                        "tr",
                        ...
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev5_ThirdPartyCount"], columnName: "Sev5_ThirdPartyCount" })
                        ),
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev4_ThirdPartyCount"], columnName: "Sev4_ThirdPartyCount" })
                        ),
                        React.createElement(
                            "td",
                            { className: "n" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["b" /* BadUnlessZero */], { value: this.props.data["Sev3_ThirdPartyCount"], columnName: "Sev3_ThirdPartyCount" })
                        )
                    )
                )
            )
...
var AVSummary = React.createClass({
    ...
    render: function () {
        ...
        if (!this.props.data["HasAV"]) return React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: !this.props.data["HasAV"], columnName: "HasAV", label: "AV Missing" });

        // Otherwise, consider details
        return React.createElement(
            "div",
            null,
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["AVName"], columnName: "AVName", label: "AV", id: this.props.data["Name"], url: "https://insights/Report?id=07e846a5-a100-498b-8fe0-68a907b695cc&isPublished=true#assetName={ID}&_tab=2", "url-title": "AV Details" }),
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["e" /* RelativeDateTime */], { value: this.props.data["LatestScanDate"], columnName: "LatestScanDate", label: "Last Scan" }),
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: !this.props.data["IsScanned"], columnName: "IsScanned", label: "Unscanned" }),
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: !this.props.data["HasAuthenticatedScan"], columnName: "HasAuthenticatedScan", label: "Unauthenticated Scan" })
        );
    }
});
...
var MonitoringSummary = React.createClass({
    ...
    render: function () {
        ...
        if (!this.props.data["IsMonitored"]) return React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: !this.props.data["IsMonitored"], columnName: "IsMonitored", label: "Unmonitored" });

        // Otherwise, consider details
        return React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["e" /* RelativeDateTime */], { value: this.props.data["LatestMonitoredDate"], columnName: "LatestMonitoredDate", label: "Last Monitored" });
    }
});
...
/* harmony default export */ __webpack_exports__["a"] = React.createClass({
    ...
    render: function () {
        ...
        fullTeam.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["S1"], columnName: "S1", inline: "true" }));
        if (this.props.data["S2"]) {
            fullTeam.push(" | ");
            fullTeam.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["S2"], columnName: "S2", inline: "true" }));
        }

        if (this.props.data["S3"]) {
            fullTeam.push(" | ");
            fullTeam.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["S3"], columnName: "S3", inline: "true" }));
        }

        if (this.props.data["S4"]) {
            fullTeam.push(" | ");
            fullTeam.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["S4"], columnName: "S4", inline: "true" }));
        }
        ...
        return React.createElement(
            ...
            React.createElement(
                "div",
                { className: "commands" },
                React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["a" /* DetailReportLink */], { url: "https://insights/Report?id=5337be64-6142-4dec-8191-711c3043d2bb&isPublished=true#assetName={ID}&_tab=0", id: this.props.data["Name"], title: "Insights Asset Detail" }),
            ...
            React.createElement(
                ...
                React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: "." + this.props.data["Domain"], columnName: "Domain", inline: "true" }),
                React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["OU"], columnName: "OU" }),
                React.createElement(
                    "div",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "div",
                            { className: "indent" },
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["IP"], columnName: "IP", label: "IP" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["Type"], columnName: "Type" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["OSVersion"], columnName: "OSVersion", label: "OS" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["Environment"], columnName: "Environment", label: "Env" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["Asset_Source"], columnName: "Asset_Source", label: "Source" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["XpertRole"], columnName: "XPertRole", label: "XPert Role" })
                        ),
                        ...
                        React.createElement(
                            ...
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["f" /* MailLink */], { to: this.props.data["ServiceOwner"], columnName: "ServiceOwner", subject: this.props.itemId, label: "FTE" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["f" /* MailLink */], { to: this.props.data["ServiceOwnerOperations"], columnName: "ServiceOwnerOperations", subject: this.props.itemId, label: "Ops" })
                        )
                    ),
                    React.createElement(
                        "div",
                        ...
                        React.createElement(
                            ...
                            { className: "indent" },
                            baselineIcon,
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["d" /* DetailsField */], { value: this.props.data["SecurityRisk"], columnName: "SecurityRisk", label: "Security Risk" }),
                            React.createElement(AVSummary, { data: this.props.data }),
                            React.createElement(MonitoringSummary, { data: this.props.data }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: this.props.data["IsEdge"], columnName: "IsEdge", label: "Edge" }),
                            React.createElement(__WEBPACK_IMPORTED_MODULE_1__ArribaComponents__["c" /* RiskMarker */], { condition: this.props.data["IsDualHomed"], columnName: "IsDualHomed", label: "Dual-Homed" }),
...
/* harmony default export */ __webpack_exports__["default"] = {
    ...
    splashContent: React.createElement(
        "div",
        null,
        "ArribaSearch is an instant-searchable index of Asset, Employee, and Administrator data.",
        React.createElement(
            "div",
            { className: "smaller" },
    ...
    accessDeniedContent: React.createElement(
        "span",
        null,
        "Access to ArribaSearch denied. To request access to the overall site, please join ",
        React.createElement(
            "a",
            { target: "_blank", href: "https://idweb/IdentityManagement/aspx/common/GlobalSearchResult.aspx?searchtype=e0c132db-08d8-4258-8bce-561687a8a51e&content=Arriba Report Reader" },
            "Arriba Report Reader"
        ),
    ...
    serviceUnavailableContent: React.createElement(
        "span",
        null,
        "ArribaSearch is currently unavailable. Please ",
        React.createElement(
            "a",
            { href: "mailto:v-scolo@microsoft.com;mikefan@microsoft.com&subject=ArribaSearch%20Unavailable" },
            "report"
        ),
        " this issue."
    )
