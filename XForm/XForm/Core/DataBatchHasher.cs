...
namespace XForm
{
    ...
    public class DataBatchHasher
    {
        ...
        {
            if (t == typeof(sbyte)) return SbyteHasher.Hash;
            if (t == typeof(byte)) return ByteHasher.Hash;
            if (t == typeof(short)) return ShortHasher.Hash;
            if (t == typeof(ushort)) return UshortHasher.Hash;
            if (t == typeof(int)) return IntHasher.Hash;
            if (t == typeof(uint)) return UintHasher.Hash;
            if (t == typeof(long)) return LongHasher.Hash;
            if (t == typeof(ulong)) return UlongHasher.Hash;
            if (t == typeof(float)) return FloatHasher.Hash;
            if (t == typeof(double)) return DoubleHasher.Hash;
            if (t == typeof(DateTime)) return DateTimeHasher.Hash;
            if (t == typeof(TimeSpan)) return TimeSpanHasher.Hash;
            if (t == typeof(Guid)) return GuidHasher.Hash;
            if (t == typeof(String8)) return String8Hasher.Hash;
