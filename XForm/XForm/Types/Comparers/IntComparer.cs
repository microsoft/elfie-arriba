...
{
    /// <summary>
    ///  IDataBatchComparer for int[].
    /// </summary>
    internal class IntComparer : IDataBatchComparer, IDataBatchComparer<int>
    {
        internal static ComparerExtensions.WhereSingle<int> s_WhereSingleNative = null;
        internal static ComparerExtensions.Where<int> s_WhereNative = null;
        ...
        public bool WhereEqual(int left, int right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(int left, int right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(int left, int right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(int left, int right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(int left, int right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(int left, int right)
        {
            return left >= right;
        }
    }
