...
namespace XForm.Types.Comparers
{
    ...
    /// </summary>
    internal class UshortComparer : IDataBatchComparer, IDataBatchComparer<ushort>
    {
        internal static ComparerExtensions.WhereSingle<ushort> s_WhereSingleNative = null;
        ...
        public bool WhereEqual(ushort left, ushort right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(ushort left, ushort right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(ushort left, ushort right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(ushort left, ushort right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(ushort left, ushort right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(ushort left, ushort right)
        {
            return left >= right;
        }
    }
