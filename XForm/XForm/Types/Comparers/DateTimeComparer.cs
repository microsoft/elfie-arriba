...
{
    /// <summary>
    ///  IDataBatchComparer for DateTime[].
    /// </summary>
    internal class DateTimeComparer : IDataBatchComparer, IDataBatchComparer<DateTime>
    {
        internal static ComparerExtensions.WhereSingle<DateTime> s_WhereSingleNative = null;
        internal static ComparerExtensions.Where<DateTime> s_WhereNative = null;
        ...
        {
            DateTime[] leftArray = (DateTime[])left.Array;
            DateTime[] rightArray = (DateTime[])right.Array;
            ...
            else if (!left.Selector.IsSingleValue)
            {
                ...
                int zeroOffset = left.Selector.StartIndexInclusive;
                DateTime rightValue = rightArray[0];
        ...
        public bool WhereEqual(DateTime left, DateTime right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(DateTime left, DateTime right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(DateTime left, DateTime right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(DateTime left, DateTime right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(DateTime left, DateTime right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(DateTime left, DateTime right)
        {
            return left >= right;
        }
    }
