...
{
    /// <summary>
    ///  IDataBatchComparer for float[].
    /// </summary>
    internal class FloatComparer : IDataBatchComparer, IDataBatchComparer<float>
    {
        internal static ComparerExtensions.WhereSingle<float> s_WhereSingleNative = null;
        ...
        public bool WhereEqual(float left, float right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(float left, float right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(float left, float right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(float left, float right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(float left, float right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(float left, float right)
        {
            return left >= right;
        }
    }
