...
namespace XForm.Types.Comparers
{
    ...
    /// </summary>
    internal class String8Comparer : IDataBatchComparer, IDataBatchTextComparer, IDataBatchComparer<String8>
    {
        ...
        public void WhereContains(DataBatch left, DataBatch right, BitVector vector)
        {
            ...
            if (left.IsNull != null || right.IsNull != null)
            {
                ...
                for (int i = 0; i < left.Count; ++i)
                {
                    ...
                    if (left.IsNull != null && left.IsNull[leftIndex]) continue;
                    if (right.IsNull != null && right.IsNull[rightIndex]) continue;
                    if (leftArray[leftIndex].Contains(rightArray[rightIndex]) != -1) vector.Set(i);
                }
            }
            else if (left.Selector.Indices != null || right.Selector.Indices != null)
            {
        ...
        public void WhereStartsWith(DataBatch left, DataBatch right, BitVector vector)
        {
            ...
            if (left.IsNull != null || right.IsNull != null)
            {
                ...
                for (int i = 0; i < left.Count; ++i)
                {
                    ...
                    if (left.IsNull != null && left.IsNull[leftIndex]) continue;
                    if (right.IsNull != null && right.IsNull[rightIndex]) continue;
                    if (leftArray[leftIndex].StartsWith(rightArray[rightIndex], true)) vector.Set(i);
                }
            }
            else if (left.Selector.Indices != null || right.Selector.Indices != null)
            {
