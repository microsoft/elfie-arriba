...
{
    /// <summary>
    ///  IDataBatchComparer for ulong[].
    /// </summary>
    internal class UlongComparer : IDataBatchComparer, IDataBatchComparer<ulong>
    {
        internal static ComparerExtensions.WhereSingle<ulong> s_WhereSingleNative = null;
        internal static ComparerExtensions.Where<ulong> s_WhereNative = null;
        ...
        {
            ulong[] leftArray = (ulong[])left.Array;
            ulong[] rightArray = (ulong[])right.Array;
        ...
        public bool WhereEqual(ulong left, ulong right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(ulong left, ulong right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(ulong left, ulong right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(ulong left, ulong right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(ulong left, ulong right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(ulong left, ulong right)
        {
            return left >= right;
        }
    }
