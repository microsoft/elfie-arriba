...
{
    /// <summary>
    ///  IDataBatchComparer for byte[].
    /// </summary>
    internal class ByteComparer : IDataBatchComparer, IDataBatchComparer<byte>
    {
        internal static ComparerExtensions.WhereSingle<byte> s_WhereSingleNative = null;
        internal static ComparerExtensions.Where<byte> s_WhereNative = null;
        ...
        public void WhereEqual(DataBatch left, DataBatch right, BitVector vector)
        {
            ...
            byte[] rightArray = (byte[])right.Array;
        ...
        public bool WhereEqual(byte left, byte right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(byte left, byte right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(byte left, byte right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(byte left, byte right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(byte left, byte right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(byte left, byte right)
        {
            return left >= right;
        }
    }
