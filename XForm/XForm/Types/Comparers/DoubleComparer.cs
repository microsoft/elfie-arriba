...
namespace XForm.Types.Comparers
{
    ...
    /// </summary>
    internal class DoubleComparer : IDataBatchComparer, IDataBatchComparer<double>
    {
        ...
        public bool WhereEqual(double left, double right)
        {
            return left == right;
        }
        ...
        public bool WhereNotEqual(double left, double right)
        {
            return left != right;
        }
        ...
        public bool WhereLessThan(double left, double right)
        {
            return left < right;
        }
        ...
        public bool WhereLessThanOrEqual(double left, double right)
        {
            return left <= right;
        }
        ...
        public bool WhereGreaterThan(double left, double right)
        {
            return left > right;
        }
        ...
        public bool WhereGreaterThanOrEqual(double left, double right)
        {
            return left >= right;
        }
    }
